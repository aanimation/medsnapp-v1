    ...
    */
    ...
    'channels' => [
        ...
        'stack' => [
            ...
            'name' => env('SLACK_CHANNEL'),
            'channels' => ['single', 'daily', 'slack', 'google-chat'],
        ],
        ...
        'slack' => [
            // https://api.slack.com/apps/A07UEQR83BQ/incoming-webhooks
            'driver' => 'slack',
            'url' => env('LOG_SLACK_WEBHOOK_URL', 'https://hooks.slack.com/services/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'),
            'username' => 'Medsnapp Log',
            'emoji' => ':boom:',
            'level' => 'debug',
            // 'replace_placeholders' => true,
        ],
        ...
        'emergency' => [
            'path' => storage_path('emergency/medsnapp.log'),
        ],
