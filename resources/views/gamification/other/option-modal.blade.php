<div wire:ignore.self class="modal fade" id="modal-option" tabindex="-1" role="dialog" aria-labelledby="modal-option" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-md modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header p-2">
				<h6 class="modal-title font-weight-normal ps-3">Reward Option</h6>
