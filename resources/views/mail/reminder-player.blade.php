...
<html>
	...
	<title>Almost There! Verify Your Email for MedSnapp</title>
						...
						<table>
							...
							<tr>
								<td style="font-size:14px; padding-bottom: 10px;">
									We noticed you signed up to MedSnapp recently but haven't verified your email to complete your registration.
								</td>
							</tr>
							<tr>
								<td style="font-size:14px; padding-bottom: 10px;">
									To complete your registration and start enjoying all our features, please click the link below:
								</td>
							</tr>
							<tr>
								<td style="padding-top:14px;padding-bottom:10px;border-bottom:1px solid #eaeaea;;">
									<a href="{{ $link }}" target="_blank" id="medsnapp-link" title="verify email">
